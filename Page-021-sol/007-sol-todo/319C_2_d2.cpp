...
//22:18 15-03-2019
//22:20 15-03-2019 to 22:23 15-03-2019 and 22:38 15-03-2019
...
long double eval(long long m, long double x, long long c){
return m*x+c;
}
...
RE(i, 1, n){
	...
	cerr << '\n';
	RE(u, 0, qi) cerr << q[u].m << ' ' << q[u].c << ' ' << q[u].xl << ' ' << q[u].xr << '\n';
	cerr << '\n';
}
RE(i, 0, n) cerr << dp[i] << ' ';
cerr << '\n';
